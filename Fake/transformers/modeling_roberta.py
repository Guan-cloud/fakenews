...
class RobertaForSequenceClassification(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.classifier = nn.Linear(config.num_filters*3, config.num_labels)
    ...
    Examples::
        ...
        while x1.size()[2] >= 2:
            x1 = self._block(x1)
        x1 = x1.squeeze(3)  # [batch_size, num_filters(250)]
        ...
        while x2.size()[2] > 2:
            x2 = self._block(x2)
        x2 = x2.squeeze(3)  # [batch_size, num_filters(250)]
        ...
        while x3.size()[2] > 2:
            x3 = self._block(x3)
        x3 = x3.squeeze(3)  # [batch_size, num_filters(250)]
